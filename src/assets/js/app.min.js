...
function ($) {
    ...
    */
    ...
    App.prototype.init = function () {
        ...
        //  RTL support js
        if(document.getElementById('app-default-stylesheet').href.includes('rtl.min.html')){
            document.getElementsByTagName('html')[0].dir="rtl";
        }
        if(document.getElementById('app-dark-stylesheet')) {

          if(document.getElementById('app-dark-stylesheet').href.includes('rtl.min.html')){
              document.getElementsByTagName('html')[0].dir="rtl";
          }
        }
    },
